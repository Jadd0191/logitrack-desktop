...
# ❌ NO importar Shipment - Solo se usa en tipos
...
class LogiTrackWindow(QMainWindow):
    ...
    def _setup_central_widget(self):
        ...
        self.counter_label.setStyleSheet("font-size: 12px; padding: 8px; border-radius: 4px;")
    ...
    def _setup_status_bar(self):
        ...
        self.statusBar().showMessage("✅ Listo | Fase 6: Arquitectura MVC/MVVM")
    ...
    def _add_shipment_to_table(self, shipment):
        """
        Añade un envío a la tabla.
        shipment es un objeto que viene del controlador (no importa models)
        """
